...
exports.auth = exports.create = exports.index = void 0;
var connection_1 = __importDefault(require("../../database/connection"));
var bcryptjs_1 = __importDefault(require("bcryptjs")); //criptografa as senhas
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    users = response.map(function (item) {
...
function create(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name, email, password, hash, userToDB, id, user, token;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    token = token_1.generateToken({ id: user.id });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    err_1 = _b.sent();
                    return [2 /*return*/, res.status(404).send({ error: "error: User not found" })];
